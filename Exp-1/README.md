Here’s the properly aligned version of your README in markdown:
...
1. **Using Docker Desktop**: Go to the **Images** section to verify if the `streamlit` image is listed.
   
2. **Using the Command Line**: Run the following command to list all Docker images:
...
This markdown is now properly aligned and formatted. You can copy and paste it directly into your `README.md` file!
